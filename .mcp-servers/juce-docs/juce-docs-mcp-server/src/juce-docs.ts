...
// Canonical JUCE documentation. Both develop and master are valid;
// master tracks the current stable release.
const BASE_URL = 'https://docs.juce.com/master';
// const BASE_URL = 'https://docs.juce.com/develop';
// const BASE_URL = 'https://ccrma.stanford.edu/~jos/juce_modules'; // third-party mirror
